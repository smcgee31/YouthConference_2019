  ...
  return (
    <Card style={ { padding: 12, margin: 6 } }>
      ...
      <CardContent style={ { marginLeft: 12 } }>
        <p>Camp Helaman will be for all young men in the Stake and all deacons, teachers and priests are invited to participate.  This 3-day camp out will replace the stake scout camp for 2019. The location details for this campout is found at the bottom of this page.</p>
